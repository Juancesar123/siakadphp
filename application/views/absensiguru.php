...
<tbody>
<tr ng-repeat="item in absensiguru">
 <td> <input type="checkbox"  checklist-model="user.hapusabsensiguru" checklist-value="item.id_absensi_guru" role></td>
<td>{{item.nama}}</td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Ubah Data Absensi Guru</h4>
      </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Input Absensi Guru</h4>
      </div>
      <div class="modal-body">
       <div class = "form-group">
	   <label>Nama</label>
